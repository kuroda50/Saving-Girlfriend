...
class ReactionService {
  ...
  void _buildRules() {
    ...
    _rules.add(ReactionRule(
      id: 'reaction_food',
      priority: 50,
      condition: (ctx) => ctx.category == TransactionCategory.food,
      reaction: (ctx, playedIds) {
        if (ctx.amount < 800) {
    ...
    _rules.add(ReactionRule(
      ...
      priority: 50,
      condition: (ctx) => ctx.category == TransactionCategory.transport,
      reaction: (ctx, playedIds) =>
    ...
    _rules.add(ReactionRule(
      ...
      priority: 50,
      condition: (ctx) => ctx.category == TransactionCategory.entertainment,
      reaction: (ctx, playedIds) =>
    ...
    _rules.add(ReactionRule(
      id: 'reaction_social',
      priority: 50,
      condition: (ctx) => ctx.category == TransactionCategory.social,
      reaction: (ctx, playedIds) =>
    ...
    _rules.add(ReactionRule(
      id: 'reaction_daily',
      priority: 50,
      condition: (ctx) => ctx.category == TransactionCategory.daily,
      reaction: (ctx, playedIds) =>
    ...
    _rules.add(ReactionRule(
      id: 'reaction_other',
      priority: 50,
      condition: (ctx) => ctx.category == TransactionCategory.other,
      reaction: (ctx, playedIds) =>
