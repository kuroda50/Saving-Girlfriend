...
class HomeScreenNotifier extends Notifier<HomeScreenState> {
  ...
  final Map<TalkTopic, List<String>> _dialogues = {
    ...
    TalkTopic.Study: ['よし、勉強の時間だ！', 'むずかしいな…', 'この問題、わかる人いる？', '集中、集中…！', 'やった、1ページ終わった!えらい？'],
    TalkTopic.Game: ['これからゲーム配信するよ！', 'やった、クリア！', 'このボス強い…！', 'みんなの応援のおかげでクリアできた！ありがとう！', '次はなんのゲームやろうかな？'],
  };
  final Map<TalkTopic, List<String>> _topicComments = {
    ...
    TalkTopic.Game: ['ないすー！', 'おおお！', 'うますぎw', '神プレイ！', 'がんばれー', '次のゲームも楽しみ', '応援してるよ！', 'すごい！', '天才かよ！'],
  };
  Timer? _commentTimer;
  Timer? _topicTimer;
